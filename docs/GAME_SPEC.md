...
The playfield is 10 columns by 20 rows. A seeded seven-piece bag supplies the seven standard four-cell geometric piece families. A player can move left or right, rotate clockwise when the rotated shape fits, soft-drop, or hard-drop. A piece locks when it can no longer descend. Completed rows clear together.
...
Touch controls occupy the bottom panel: tap left or right to move, tap the upper-right zone to rotate, and tap the lower-right zone to hard-drop. Desktop arrow keys and Space provide development controls.
